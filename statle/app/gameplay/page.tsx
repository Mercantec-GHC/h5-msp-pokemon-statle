        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="flex flex-col items-center text-center p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-md">
           ...
           <div className="relative w-48 h-48">
              ...
              />
              {/* <div>
                <span className="absolute bottom-0 right-0 bg-green-500 text-white text-xs font-semibold px-2 py-1 rounded-full transform translate-x-1/2 translate-y-1/2">
                  Grass/Poison
                </span>
              </div> */}
